...
func registerV1Routes(r chi.Router, authMW func(http.Handler) http.Handler, auditMW func(http.Handler) http.Handler, rateLimitMW func(http.Handler) http.Handler, bucketService handlers.BucketConnectionService, authorizationService handlers.AuthorizationService, objectUploadService handlers.ObjectUploadService, objectDeleteService handlers.ObjectDeleteService, objectPresignService handlers.ObjectPresignService) {
